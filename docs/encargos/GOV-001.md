...
- Fecha de aceptación: `2026-08-25`.
- Decisión: Raúl, como Product Owner y autoridad final, acepta expresamente GOV-001 y autoriza su merge, despliegue documental en Nexus y verificación.
- Limitación conocida: algunos diagramas Mermaid pueden quedar parcialmente recortados en una pantalla de 390 px y el informe `validacion.json` podría detallar más el clipping interno.
- Tratamiento: la limitación móvil y el detalle pendiente del informe quedan aceptados como deuda documental menor y no bloqueante; no se abre otro ciclo de corrección dentro de GOV-001.
