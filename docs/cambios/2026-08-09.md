...
- Los [PR #4](https://github.com/ratienza/Reserva-Pistas-UTP/pull/4), [#5](https://github.com/ratienza/Reserva-Pistas-UTP/pull/5) y [#6](https://github.com/ratienza/Reserva-Pistas-UTP/pull/6) integraron mediante squash el motor de sincronización, la corrección del usuario de runtime y la guía de despliegue validada. El borrador #1 quedó cerrado al ser sustituido.
...
- Nexus quedó operativo en `192.168.18.220:8083` y DigitalOcean en `https://app.raulatienza.com/padel/`; no se alteraron DNS, certificados, puertos ni la topología pública. El [issue #2](https://github.com/ratienza/Reserva-Pistas-UTP/issues/2) quedó cerrado con evidencias.
